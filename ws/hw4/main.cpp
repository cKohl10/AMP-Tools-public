...
//     amp::ManipulatorState state2a = {M_PI/6.0, M_PI/3.0, (7.0*M_PI)/4.0};
...
//     amp::ManipulatorState state2b = manipulator2b.getConfigurationFromIK(Eigen::Vector2d(-0.268559, -0.288032));
...
//     double x0 = M_PI/4.0;
//     double x1 = M_PI/2.0;
//     amp::ManipulatorState state3a = {x0, x1};
